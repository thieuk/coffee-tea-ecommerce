            ...
            <div id="account" className="w-fit sm:h-[475px] h-fit flex items-center border-2 border-purple-900 rounded-xl sm:px-16 sm:py-0 p-5 gap-9 shadow-2xl">
                <div id="signup" className="hidden flex flex-col justify-center w-[240px] sm:scale-100 scale-90">
                    ...
                    <form id="signup" className="flex flex-col justify-center">
                        <input type="email" id="signup-username" placeholder="Username" required autoComplete="email" className="mt-5 border-2 border-purple-900 p-1 rounded"/>
                        ...
                        <button onClick={(event) => { event.preventDefault(); handleDisplayMsg()}} type="submit" className="w-fit bg-amber-400 hover:bg-amber-500 py-2 px-3 font-bold rounded mt-4 mx-auto">SIGN UP</button>
                    </form>
                ...
                <div id="signin" className="flex flex-col justify-center w-[240px] sm:scale-100 scale-90">
                    ...
                    <form id="signin" className="flex flex-col justify-center">
                        ...
                        <button onClick={(event) => { event.preventDefault(); handleDisplayMsg()}} className="flex justify-center items-center mt-5 py-2 bg-neutral-200 rounded hover:bg-neutral-300">
